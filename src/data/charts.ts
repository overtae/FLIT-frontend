...
export const visitorsChartData: ChartDataPoint[] = [
...
export const revenueDailyData: RevenueChartData[] = [
...
export const revenueYearlyData: RevenueChartData[] = [
...
export const productCategoryData: CategoryChartData[] = [
  { name: "꽃", revenue: 4000 },
  { name: "식물", revenue: 3000 },
  { name: "화환", revenue: 2000 },
  { name: "공간연출", revenue: 2780 },
  { name: "정기배송", revenue: 1890 },
];

export const productDailyRevenue: RevenueChartData[] = [
...
export const productYearlyData: RevenueChartData[] = [
  { year: "2020", revenue: 400 },
  { year: "2021", revenue: 300 },
  { year: "2022", revenue: 200 },
  { year: "2023", revenue: 278 },
...
export const categoryGroupData: CategoryChartData[] = [
...
export const categoryProductData: CategoryChartData[] = [
