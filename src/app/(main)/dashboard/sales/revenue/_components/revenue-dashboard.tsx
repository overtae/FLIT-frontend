    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-1">
          <div className="text-foreground text-3xl font-bold">{totalRevenue.toLocaleString()} 원</div>
        </div>
        ...
        <div className="col-span-2 grid grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <TooltipProvider>
              <Tooltip open={isTooltipOpen} onOpenChange={setIsTooltipOpen}>
                ...
                <TooltipContent className="bg-card border-input border p-4 shadow-lg">
                  <div className="space-y-2">
                    ...
                    <Button size="sm" className="mt-2 w-full" onClick={() => setIsTooltipOpen(false)}>
                      OK
                    </Button>
                  </div>
                </TooltipContent>
          ...
          <div className="space-y-2">
            <div className="text-secondary-foreground text-sm">
              환불 | 취소 금액{" "}
              <span className="text-foreground font-semibold">{refundCancelAmount.toLocaleString()}원</span>
            </div>
            <div className="text-secondary-foreground text-sm">
              환불 | 취소 건수 <span className="text-foreground font-semibold">{refundCancelCount}건</span>
            </div>
            <div className="text-secondary-foreground text-sm">
