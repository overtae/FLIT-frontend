    ...
    <div className="space-y-4">
      ...
      <ResponsiveContainer width="100%" height={400}>
        <AreaChart data={monthlyData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
          ...
          <Area type="monotone" dataKey="thisMonth" stroke="#8884d8" fillOpacity={1} fill="url(#colorThisMonth)" />
          <Area type="monotone" dataKey="lastMonth" stroke="#82ca9d" fillOpacity={1} fill="url(#colorLastMonth)" />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
