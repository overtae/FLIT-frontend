...
import { generateProductNetQuarter } from "@/data/sales";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const endpoint = queryString ? `/sales/product/net/quarter?${queryString}` : "/sales/product/net/quarter";
    ...
    return NextResponse.json({ error: "Failed to fetch product quarter net" }, { status: 500 });
  }
}
